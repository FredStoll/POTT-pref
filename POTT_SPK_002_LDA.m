...
param.predic = {'I_chosenjuice' 'I_chosenproba' 'I_unchosenproba' 'I_chosenproba_juice'}; %- select param you want to test..
param.predic = {'I_chosenside' }; %- select param you want to test..
